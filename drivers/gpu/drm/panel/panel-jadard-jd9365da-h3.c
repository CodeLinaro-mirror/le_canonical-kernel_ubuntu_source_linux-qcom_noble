...
static const struct jadard_init_cmd waveshare_8_0_inch_a_init_cmds[] = {
	{ .data = { 0xE0, 0x00 } },
	{ .data = { 0xE1, 0x93 } },
	{ .data = { 0xE2, 0x65 } },
	{ .data = { 0xE3, 0xF8 } },
...
static const struct jadard_panel_desc waveshare_8_0_inch_a_desc = {
	...
	.lanes = 4,
	.format = MIPI_DSI_FMT_RGB888,
	.init_cmds = waveshare_8_0_inch_a_init_cmds,
	.num_init_cmds = ARRAY_SIZE(waveshare_8_0_inch_a_init_cmds),
};
