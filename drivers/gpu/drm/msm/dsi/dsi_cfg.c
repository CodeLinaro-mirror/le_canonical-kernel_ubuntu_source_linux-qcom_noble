...
static const struct regulator_bulk_data sa8775_dsi_regulators[] = {
	{ .supply = "vdda", .init_load_uA = 30100 },    /* 1.2 V */
	{ .supply = "refgen" },
};

static const struct msm_dsi_config sa8775_dsi_cfg = {
	.io_offset = DSI_6G_REG_SHIFT,
	.regulator_data = sa8775_dsi_regulators,
	.num_regulators = ARRAY_SIZE(sa8775_dsi_regulators),
	.bus_clk_names = dsi_v2_4_clk_names,
	.num_bus_clks = ARRAY_SIZE(dsi_v2_4_clk_names),
	.io_start = {
		{ 0xae94000, 0xae96000 },
...
static const struct msm_dsi_cfg_handler dsi_cfg_handlers[] = {
	...
	{MSM_DSI_VER_MAJOR_6G, MSM_DSI_6G_VER_MINOR_V2_5_1,
		&sa8775_dsi_cfg, &msm_dsi_6g_v2_host_ops},
